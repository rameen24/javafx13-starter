...
public class Skjermkort_Admin implements Initializable {
    ...
    void vistabelaction(ActionEvent event) {
        ...
        try {
            ThreadHåndtering thread = new ThreadHåndtering("src/main/resources/Test/skjermkort.jobj") ;
    ...
    void lagretabelaction(ActionEvent event) throws IOException {
        FileWriter fw = new FileWriter("src/main/resources/Test/skjermkort.jobj", false);
